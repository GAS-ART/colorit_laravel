         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/consulado.png')}}"
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/moonsters.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/1.png')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/marista.png')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/2.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/3.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/4.png')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/5.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/6.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/7.png')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/8.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/10.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/11.png')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
            ...
            <div class="swiper-slide">
               <div class="black-image">
                  <img class="swiper-lazy" data-src="{{asset('img/clients/black/12.jpg')}}"
                     src="{{asset('img/1px.jpg')}}" alt="Our clients">
               </div>
               <div class="color-image">
