...
<section class="main-baner-top">
   <div class="main-baner-top__body">
      <img class="main-baner-top__lage" src="{{asset('img/outdoor_advertising/main.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.baner')">
      <img class="main-baner-top__small" src="{{asset('img/outdoor_advertising/main_small.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.baner')">
   ...
   <div class="outdor-advertising-products__container">
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/letters.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.letter')">
         </div>
      ...
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         ...
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/neon_signs.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.neon')">
         </div>
         <button
            class="item-outdor-advertising-products__btn-mobile description-product__btn popup-btn">@lang('main.order')</button>
      </div>
      ...
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/led_screen.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.led')">
         </div>
         <div class="item-outdor-advertising-products__description description-product">
            <h2 class="description-product__tittle">
      ...
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         ...
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/lightboxes.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.lightbox')">
         </div>
         <button
            class="item-outdor-advertising-products__btn-mobile description-product__btn popup-btn">@lang('main.order')</button>
      </div>
      ...
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/oracal.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.oracal')">
         </div>
         <div class="item-outdor-advertising-products__description description-product">
            <h2 class="description-product__tittle">
      ...
      <div class="outdor-advertising-products__item item-outdor-advertising-products">
         ...
         <div class="item-outdor-advertising-products__img">
            <img src="{{asset('img/outdoor_advertising/baner.jpg')}}" alt="@lang('altTag.outdoorAdvertasing.services.baner')">
         </div>
         <button
            class="item-outdor-advertising-products__btn-mobile description-product__btn popup-btn">@lang('main.order')</button>
      </div>
   ...
   <div class="outdor-advertising-advantages__container">
      ...
      <div class="outdor-advertising-advantages__body ">
         ...
         <div class="outdor-advertising-advantages__item outdor-advertising-advantages-item">
            ...
            <div class="outdor-advertising-advantages-item__text">@lang('outdorAdvertising.advantages.price_text_1')
            </div>
         </div>
         <div class="outdor-advertising-advantages__item outdor-advertising-advantages-item">
            <div class="outdor-advertising-advantages-item__tittle">
